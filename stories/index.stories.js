...
storiesOf("Spinner", module)
  .add("install", () => (
    <Section>
      ...
      <p>
        <a href="https://github.com/chantastic/react-svg-spinner">
          Source on Github
        </a>
      </p>
...
`}
  ...
  .add("default", () => (
    <Section>
      <h2>Defaults</h2>
      <p>
        <code>react-svg-spinner</code> is a small, self-spinning SVG.
      </p>
  ...
  .add("prop: size", () => (
    <Section>
      ...
      <p>
        <code>size</code> is a shorthand for setting <code>height</code> and{" "}
        <code>width</code> similtaniously.
      </p>
      ...
      <p>
        <code>height</code> and <code>width</code> can be set independantly as
        well.
      </p>
  ...
  .add("prop: color", () => (
    <Section>
      ...
      <p>
        <code>color</code> sets the color of the spinner. (big surprises,
        people.)
      </p>
  ...
  .add("prop: thickness", () => (
    <Section>
      ...
      <p>
        <code>thickness</code> sets the thickness of your spinner.
      </p>
      <p>
        This <strong>does not</strong> map to any absolute value. It is relative
        to the SVG size
      </p>
  ...
  .add("prop: gap", () => (
    <Section>
      ...
      <p>
        <code>gap</code> sets the space between the broken ends of the circle.
      </p>
      <p>
        This <strong>does not</strong> map to any absolute value. And varies
        wildly based on <code>thickness</code>.
      </p>
  ...
  .add("prop: speed", () => (
    <Section>
      ...
      <p>
        <code>speed</code> sets the animation speed.
      </p>
      <p>
        There are three speeds <code>fast</code>, <code>slow</code>, and the
        default.
      </p>
